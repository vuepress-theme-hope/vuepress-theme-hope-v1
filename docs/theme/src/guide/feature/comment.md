...
`vuepress-theme-hope` implements the comment feature with built-in [`vuepress-plugin-comment1`](https://vuepress-theme-hope.github.io/v1/comment/).
...
For the complete config item of the plugin ,please see [vuepress-plugin-comment1 plugin documentation](https://vuepress-theme-hope.github.io/v1/comment/).
