...
export interface HopeThemeSidebarLocaleOptions {
   ...
   * @see https://vuepress-theme-hope.github.io/v1/guide/layout/sidebar.html
   *
   * 侧边栏配置
   *
   * @description 设置为 `false` 以在当前语言中禁用侧边栏
   * @see https://vuepress-theme-hope.gitee.io/v1/zh/guide/layout/sidebar.html
   */
  sidebar?: HopeThemeSidebarConfig | "heading" | false;
